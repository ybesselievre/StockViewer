go.layout.Template({
    'data': {'bar': [{'error_x': {'color': '#f2f5fa'},
                      ...
                      'marker': {'line': {'color': '#212a30', 'width': 0.5},
                                 'pattern': {'fillmode': 'overlay', 'size': 10, 'solidity': 0.2}},
                      'type': 'bar'}],
             'barpolar': [{'marker': {'line': {'color': '#212a30', 'width': 0.5},
                                      'pattern': {'fillmode': 'overlay', 'size': 10, 'solidity': 0.2}},
                           'type': 'barpolar'}],
             ...
             'surface': [{'colorbar': {'outlinewidth': 0, 'ticks': ''},
                          'colorscale': [[0.0, '#0d0887'], [0.1111111111111111,
                                         ...
                                         '#fdca26'], [1.0, '#f0f921']],
                          'type': 'surface'}],
             'table': [{'cells': {'fill': {'color': '#506784'}, 'line': {'color': '#212a30'}},
                        'header': {'fill': {'color': '#2a3f5f'}, 'line': {'color': '#212a30'}},
                        'type': 'table'}]},
    'layout': {'annotationdefaults': {'arrowcolor': '#f2f5fa', 'arrowhead': 0, 'arrowwidth': 1},
               ...
               'sliderdefaults': {'bgcolor': '#C8D4E3', 'bordercolor': '#212a30', 'borderwidth': 1, 'tickwidth': 0},
